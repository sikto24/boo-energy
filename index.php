...
<?php echo do_shortcode( '[caf_filter id="1535"]' ); ?>
				...
				<div id="blog-postbox-main" class="boo-postbox-wrapper blog-featured-posts">
					<?php if ( $custom_query->have_posts() ) : ?>
									...
									<div class="row">
										<div class="col">
											<div class="boo-postbox-pagination d-flex justify-content-center">
												<a href="<?php echo home_url( '/' ) . 'skolan/'; ?>" class="boo-btn boo-btn-white">
						...
						<div class="boo-postbox-pagination text-center d-pt-32">
							<a href="#" id="load-more-post-btn" class="boo-btn" data-max-pages="<?php echo $max_pages; ?>">
